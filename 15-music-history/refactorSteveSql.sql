...
INSERT INTO Album VALUES (null, 'Screaming for Vengeance', '06/17/1982', 2322, 4, 1, 2);
INSERT INTO Album VALUES (null, 'Point of Entry', '02/26/1981', 2262, 4, 1, 2);
INSERT INTO Album VALUES (null, 'Defenders of the Faith', '01/04/1984', 2383, 4, 1, 2);

INSERT INTO Album VALUES (null, 'Round About Midnight', '03/06/1957', 2327, 4, 24, 4);
INSERT INTO Album VALUES (null, 'Miles Ahead', '10/21/1957', 2132, 4, 24, 4);
INSERT INTO Album VALUES (null, 'Milestones', '09/02/1958', 2856, 4, 24, 4);

INSERT INTO Album VALUES (null, "Moanin' in the Moonlight", '05/14/1959', 2033, 5, 7, 3);
INSERT INTO Album VALUES (null, "Howlin' Wolf", '10/21/1957', 1917, 5, 7, 3);
INSERT INTO Album VALUES (null, "The Howlin' Wolf Album", '09/02/1969', 2459, 5, 7, 3);

INSERT INTO Album
SELECT null, "Eliminator", '3/23/1983', 2668, 6, a.ArtistId, g.GenreId
FROM Artist a, Genre g
WHERE a.ArtistName = "ZZTop" AND g.Label = "Rock";

INSERT INTO Album
SELECT null, "Afterburner", '1/1/2011', SUBSTR(ABS(RANDOM())||'', 0, 4), 6, ArtistId, GenreId
FROM Artist a, Genre g
WHERE a.ArtistName = "ZZTop" AND g.Label = "Rock";

INSERT INTO Album
SELECT null, "Tres Hombres", '6/14/1979', SUBSTR(ABS(RANDOM())||'', 0, 4), 6, ArtistId, GenreId
FROM Artist a, Genre g
WHERE a.ArtistName = "ZZTop" AND g.Label = "Rock";


INSERT INTO Album VALUES (null, "Damaged", '12/05/1981', 2098, 7, 8, 9);
INSERT INTO Album VALUES (null, "TV Party", '07/12/1982', 409, 7, 8, 9);
INSERT INTO Album VALUES (null, "Everything Went Black", '12/03/1982', 3718, 7, 8, 9);
...
SELECT s.Title 'Song', a.Title 'Album', r.LabelName 'Record Label'
FROM Song s
LEFT JOIN Album a ON s.AlbumId = a.AlbumId
LEFT JOIN RecordLabel r ON a.LabelId = r.LabelId
