...
namespace ex_1
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      Student michael = new Student("Michael", "Roberts");
      ...
      steve.Assign(ex1, elliot);
			jisie.Assign(ex3, elliot);

      Console.WriteLine();
      Console.WriteLine("All Elliot's Exercises:");
      foreach (Exercise assignment in elliot.AssignedExercises)
      {
